...
<head>
	...
	<link rel="shortcut icon" href="<?=url('_assets/img/logo/nav1_logo.svg')?>" type="image/x-icon">
</head>
<body>
	...
	<header>
		<nav>
			<div class="logo">
				<a href="<?=url()?>">
					<img src="<?=url('_assets/img/logo/nav1_logo.png')?>" alt="Rumah Laundry Logo">
				</a>
			</div>
			<ul class="nav-menu">
				<li>
					<span id="localhost"><?= ucfirst($_SESSION['master']) ?></span>
